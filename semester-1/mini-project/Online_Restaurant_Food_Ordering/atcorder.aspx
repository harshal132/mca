<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="atcorder.aspx.cs" Inherits="atcorder" %>
    ...
    <div class="container" style="margin-top:40px;">
        ...
        <div class="col-md-4">
            ...
            <div style="margin-bottom:10px;">
                &nbsp;&nbsp;&nbsp;<b> Only Cash On Delivery Avaliable<br />
                <br />
                Order ID:#<asp:Label ID="Label10" runat="server"></asp:Label>
                <br />
                <br />
                </b></div>
