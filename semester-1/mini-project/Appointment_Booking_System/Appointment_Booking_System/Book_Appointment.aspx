...
<ul>
   ...
   <li>
    ...
    <div>
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DatabaseConnectionString %>" SelectCommand="SELECT [Name] FROM [DoctorDetails]"></asp:SqlDataSource>
